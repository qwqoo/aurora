 ...
 * 图片 cdn 加速，只对时雨个人使用
 */
const isMe = location.host.includes('qwqoo.com')
const GithubPrefix = 'raw.githubusercontent.com/qwqoo/yoi/master'
const JSDriverPrefix = 'cdn.jsdelivr.net/gh/qwqoo/yoi@latest'
